...
Hi all, this is my website. Nothing too fancy, just a place for me to share my content. As mentioned over on the [Projects](/projects) page, this website serves as a proof of concept for various HTML/CSS tricks. The purpose of this post is to dive into those details.
...
![PhatLoots Presented by Bing](images\Bing%20Presented%20by%20Bing.png)
...
This was a fun challenge back when I worked on [Minecraft plugins](/plugins). I wanted to bring my plugin documentation to my website as well as add a few features not provided by BukkitDev. The plugins are no longer updated but I wanted to keep the documentation to highlight some functionality.
